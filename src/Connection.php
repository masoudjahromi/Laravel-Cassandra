<?php
namespace Masoudjahromi\LaravelCassandra;
    ...
    protected function _connect() {
        foreach($this->_nodes as $options){
            if (is_string($options)){
                ...
                $className = isset($options['class']) ? $options['class'] : 'Masoudjahromi\LaravelCassandra\Connection\Socket';
                try {
        ...
        switch($version) {
            case 0x83:
                ...
                static $responseClassMap = [
                    Frame::OPCODE_ERROR            => 'Masoudjahromi\LaravelCassandra\Response\Error',
                    Frame::OPCODE_READY            => 'Masoudjahromi\LaravelCassandra\Response\Ready',
                    Frame::OPCODE_AUTHENTICATE    => 'Masoudjahromi\LaravelCassandra\Response\Authenticate',
                    Frame::OPCODE_SUPPORTED        => 'Masoudjahromi\LaravelCassandra\Response\Supported',
                    Frame::OPCODE_RESULT        => 'Masoudjahromi\LaravelCassandra\Response\Result',
                    Frame::OPCODE_EVENT            => 'Masoudjahromi\LaravelCassandra\Response\Event',
                    Frame::OPCODE_AUTH_SUCCESS    => 'Masoudjahromi\LaravelCassandra\Response\AuthSuccess',
                ];
                ...
                $response = new $responseClass($header, new StreamReader($body));
